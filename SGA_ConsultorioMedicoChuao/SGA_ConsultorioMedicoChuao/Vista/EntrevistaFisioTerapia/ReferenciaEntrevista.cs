...
namespace SGA_ConsultorioMedicoChuao.Vista.EntrevistaFisioTerapia
{
    public partial class ReferenciaEntrevista : Form
    {
        ...
        private void B_Siguiente_Click(object sender, EventArgs e)
        {
            ...
            {
                llenaDatos();
                SGA_ConsultorioMedicoChuao.Vista.EntrevistaFisioTerapia.Hitos nuevaVentana = new SGA_ConsultorioMedicoChuao.Vista.EntrevistaFisioTerapia.Hitos();
                nuevaVentana.Show();
                this.Close();
            }
            else
        ...
        {
            llenaDatos();
            SGA_ConsultorioMedicoChuao.Vista.EntrevistaFisioTerapia.DatosPersonalesFisio nuevaVentana = new SGA_ConsultorioMedicoChuao.Vista.EntrevistaFisioTerapia.DatosPersonalesFisio();
            nuevaVentana.Show();
            this.Close();
        }
